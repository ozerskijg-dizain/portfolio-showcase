...
import { ExternalLink, ChevronDown, Globe, ShoppingCart, Camera, Send, Download, Menu, X, Utensils, Briefcase, Home, Stethoscope, GraduationCap, Scissors, Car, Dumbbell, Book } from "lucide-react";
      ...
      <section id="about" className="py-24 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p className="text-foreground text-xl font-semibold">Привет, меня зовут Вебожитель 👋</p>
            <p>
